...
Parser.prototype = {
  ...
  parseText: function (noEmpasis) {
    var lineToken = this.lexer.getNextToken();
    return this.createTextNode(lineToken.content, noEmpasis);
  },
  ...
  createTextNode: function (text, noEmpasis) {
    return noEmpasis ? Node.createText(null, { value: text })
